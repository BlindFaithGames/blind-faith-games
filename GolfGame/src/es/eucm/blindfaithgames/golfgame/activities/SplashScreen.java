...
public class SplashScreen extends Activity {
	...
	private static final String ADVICE = "es.eucm.blindfaithgames.golfgame.activities.SlashAdvice";
        ...
        Thread splashTread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    finish();
                    startActivity(new Intent("es.eucm.blindfaithgames.golfgame.activities.MainActivity"));
                    stop();
                }
            }
        };
        ...
        Thread splashTread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    finish();
                    Intent i = new Intent("es.eucm.blindfaithgames.golfgame.activities.SplashScreen");
                    i.putExtra(ADVICE, 1);
                    startActivity(i);
                    stop();
                }
